...
a = int(input("Число в целочисленном типе данных"))  # Преобразование введенной строки к целочисленному типу данных

b = float(input("Вещественное число"))  # Считайте с клавиатуры вещественное число. Используйте функцию float()
print("Сумма чисел =", a + b)  # Выведите на экран сумму a и b
