...
print(hello +world+'!'+ 2*world , hello,hello+'!')
########
...
p_letter = 'python' # Используйте переменную python для получения строки "pthn".
print(p_letter[0]+p_letter[2]+p_letter[3]+p_letter[5])
########
