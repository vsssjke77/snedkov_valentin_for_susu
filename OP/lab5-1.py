...
print(name == "Jonh" or not age == 17)  # Напишите логическое выражение со значением "человека зовут John или ему 17" с использованием оператора not
...
print(name != "John" and not name[0] == 'E')